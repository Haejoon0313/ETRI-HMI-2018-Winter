...
class Chameleon: SCNScene {
	...
	private func playTurnAnimation(_ animation: SCNAnimation) { //set rotation Angle 3.141592../4
		...
		let modelBaseNode = contentRootNode.childNodes[0] //contentRootNode의 뿌리
